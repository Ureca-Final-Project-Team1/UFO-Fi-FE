...
1. 회사는 회원에게 다음 각 호의 서비스를 제공합니다.
    ...
    회원은 회사가 제공하는 결제 시스템(토스페이먼츠)을 통해 ZET(포인트성 재화)를 충전하고, 이를 데이터 구매 시 

    사용할 수 있습니다.

    결제는 토스페이먼츠를 통해 안전하게 처리되며, 결제 수수료는 토스페이먼츠 정책에 따라 부과됩니다.

    결제 관련 문의사항은 토스페이먼츠 고객센터를 통해 처리됩니다.
