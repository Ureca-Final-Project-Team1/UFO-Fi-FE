    ...
    <header className="fixed top-0 left-1/2 transform -translate-x-1/2 h-14 z-30 w-full min-w-[375px] max-w-[620px] bg-primary-700 shadow-sm">
      <div className="flex items-center justify-between h-full px-4 w-full">
        ...
        <div className="flex items-center gap-3">
          {/* ZET 잔액 표시 */}
          <div
            className="w-[124px] h-[36px] bg-primary-700 border-2 border-blue-500 rounded-xl flex items-center justify-center cursor-pointer hover:bg-primary-600 transition-colors px-3"
